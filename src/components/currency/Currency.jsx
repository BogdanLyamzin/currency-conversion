...
const Currency = () => {
  ...
  const onFromCurrencyChange = ({target}) => setFromCurrencyShortCode(target.value);

  // const onFromCurrencyChange = (event) => {
  //   handleCurrencyChange(event.target.value, setFromCurrencyShortCode);
  // };

  const onToCurrencyChange = ({target}) => setToCurrencyShortCode(target.value);
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Button type="button" onBtnClick={onClearAllClick}>Clear</Button>
      </form>
    </>
  );
};
